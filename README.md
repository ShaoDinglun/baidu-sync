...
```json
{
  ...
  "tasks": [
    {
      "task_id": "a-share-ticks",
      "name": "A股数据全量拉取",
      "enabled": true,
      "auto_run_enabled": true,
      "cron": "15 * * * *",
      "remote_root": "/A股数据_分笔数据",
      "local_root": "/data/bypy/A股数据_分笔数据",
...
```bash
/home/leon/baidu-autosave/.venv/bin/python -m backend.bypy_sync.incremental_sync --config /home/leon/baidu-autosave/config/bypy_sync.json
/home/leon/baidu-autosave/.venv/bin/python -m backend.bypy_sync.full_sync --config /home/leon/baidu-autosave/config/bypy_sync.json
```
...
```bash
# 每天凌晨 1:15 执行一次增量同步
15 1 * * * cd /home/leon/baidu-autosave && /home/leon/baidu-autosave/.venv/bin/python -m backend.bypy_sync.incremental_sync --config config/bypy_sync.json >> /home/leon/baidu-autosave/log/bypy_sync/cron_incremental.log 2>&1

# 每 30 分钟执行一个指定任务的增量同步
*/30 * * * * cd /home/leon/baidu-autosave && /home/leon/baidu-autosave/.venv/bin/python -m backend.bypy_sync.incremental_sync --config config/bypy_sync.json --task "A股数据分笔数据全量拉取" >> /home/leon/baidu-autosave/log/bypy_sync/cron_incremental.log 2>&1
```
